      ...
      >
          ...
          <form className="h-3/4 w-1/2 text-gray-50" onSubmit={handleSubmit}>
            <ClientOnly>
              ...
              {editMode ? (
                ...
                <h4 className="text-base font-light text-gray-100">
                  We just need a bit of info from you to tailor your experience.
                </h4>
              )}
            ...
            <div className="mt-12 text-lg">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Help us tailor your trip by selecting how strenuous of outdoor
                activities that you want to be recommended.
              </p>
              <RadioSelector
                active={activeLevel}
                ...
                <div className="mt-16 mb-20">
                  {editMode ? (
                    <div className="flex flex-row gap-4">
                      <DarkOutlineButton type="submit">Save</DarkOutlineButton>
                      <DarkOutlineButton
                        onClick={() => {
                          clearTrip();
                          router.back();
        ...
        <div
          className={`w-full h-full absolute top-0 left-0 z-30 duration-200 ease-in-out ${
            show ? `bg-slate-900 bg-opacity-70` : `bg-opacity-0 hidden`
          }`}
        ></div>
      </div>
      <AdvChange />
