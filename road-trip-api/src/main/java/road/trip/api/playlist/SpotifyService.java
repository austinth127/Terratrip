...
public class SpotifyService {
    ...
    public PlaylistResponse generatePlaylist(GeneratePlaylistRequest request) {
        ...
        Optional<GeneratedPlaylist> playlist = gpRepository.findById(playlistId);

        if (playlist.isEmpty() || playlist.get().getUser() != userService.user()) {
            // playlist for this trip wasn't generated by this user,
            ...
            // playlist for this trip was generated by this user,
            // so recycle the old playlist
